...
public class DetailApprove extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ImageListAdapterApp2(DetailApprove.this,R.layout.image_item_app2,imgList);
        ...
        marshMallowPermission = new MarshMallowPermission(DetailApprove.this);
