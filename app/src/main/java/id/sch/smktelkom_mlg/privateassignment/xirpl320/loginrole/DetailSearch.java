...
public class DetailSearch extends AppCompatActivity {
    ...
    private List<ImageUploadSearch> imgList;
    private ListView lv;
    private ImageListAdapterSearch adapter;
...
//    Button btnDownload;
  ...
  //      btnDownload = (Button) findViewById(R.id.btnDownload) ;
        ...
        adapter = new ImageListAdapterSearch(DetailSearch.this, R.layout.image_item_search, imgList);
        ...
        quer.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ImageUploadSearch img = snapshot.getValue(ImageUploadSearch.class);
        ...
        marshMallowPermission = new MarshMallowPermission(DetailSearch.this);
