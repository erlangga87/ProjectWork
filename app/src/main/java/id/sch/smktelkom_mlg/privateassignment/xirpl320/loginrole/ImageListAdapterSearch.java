...
public class ImageListAdapterSearch extends ArrayAdapter<ImageUploadSearch> {
    ...
    public ImageListAdapterSearch(Context context, int resource, List<ImageUploadSearch> objects) {
